...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'cryptomatic.com'
  config.app_name = 'Cryptomatic'
  config.mailer.from = 'Cryptomatic <no-reply@cryptomatic.com>'
  ...
  #
  config.app_secret = '2sSLvjVHKp2qdk7j4CrhuYHEh9Y2S7nnNEDIB12IDXjbQmozSuOGMj6t2JHoF-m1cU4'
